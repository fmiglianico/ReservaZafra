...
(function ($) {
    ...
    function heroSliderOwl() {
        ...
        heroOwlSlider.owlCarousel({
            ...
            loop: true,
            autoHeight : true,
            navText: ["<img src='../static/img/assets/slider-left-thin-arrow.png'>", "<img src='../static/img/assets/slider-right-thin-arrow.png'>"]
        });
    ...
    function lightbox() {
        $('.lightbox').magnificPopup({
            ...
            gallery:{
                enabled:true,
                arrowMarkup: '<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"><img src="static/img/assets/slider-left-thin-arrow.png"></button>',
            },
